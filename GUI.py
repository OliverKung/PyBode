...
class Ui_pyBode(object):
    def setupUi(self, pyBode):
        ...
        self.verticalLayout_17.addWidget(self.StartButton)
    ...
    def retranslateUi(self, pyBode):
        ...
        pyBode.setWindowTitle(_translate("pyBode", "MainWindow"))
        ...
        self.OSC_Sync.setItemText(0, _translate("pyBode", "OFF"))
        self.OSC_Sync.setItemText(1, _translate("pyBode", "CH1"))
        self.OSC_Sync.setItemText(2, _translate("pyBode", "CH2"))
        self.OSC_Sync.setItemText(3, _translate("pyBode", "CH3"))
        self.OSC_Sync.setItemText(4, _translate("pyBode", "CH4"))
        ...
        self.AFG_Sync.setItemText(0, _translate("pyBode", "OFF"))
        self.AFG_Sync.setItemText(1, _translate("pyBode", "CH1"))
        self.AFG_Sync.setItemText(2, _translate("pyBode", "CH2"))
        self.label_18.setText(_translate("pyBode", "Amp"))
        self.Amplitude.setText(_translate("pyBode", "10e-3"))
